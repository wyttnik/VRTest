...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    public class InteractionAnimator : MonoBehaviour
    {
        ...
        void OnSelect(SelectEnterEventArgs args)
        {
            ...
            Debug.Log(controllerInteractor.selectTarget);
            //Debug.Log(controllerInteractor.interactablesSelected[0].transform.FindChild());
            Debug.Log(controllerInteractor.GetOldestInteractableSelected().ToString());
